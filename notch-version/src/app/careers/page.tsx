...
import {
  ...
  ArrowRightIcon, ArrowDownIcon, PlusIcon
...
export default function CareersPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="pt-[clamp(140px,18vw,200px)] pb-[clamp(60px,8vw,100px)] px-[clamp(20px,5vw,80px)] text-center relative overflow-hidden bg-[#F8FAFC]">
        <div className="absolute top-[-40%] left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-[radial-gradient(circle,rgba(124,58,237,0.1)_0%,transparent_70%)] rounded-full pointer-events-none" />
        ...
        <p className="text-[clamp(1.05rem,2vw,1.25rem)] text-gray-500 max-w-[560px] mx-auto leading-[1.7]">
          We&apos;re a fully remote team of makers, thinkers, and problem-solvers building digital products that matter. Join us and do the best work of your career.
        </p>

        <Link
          href="#open-roles"
          className="inline-flex items-center gap-2.5 px-9 py-4 bg-purple-500 text-white rounded-full text-base font-semibold transition-all shadow-[0_4px_20px_rgba(124,58,237,0.3)] hover:bg-purple-600 hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(124,58,237,0.4)] mt-6"
        >
          View Open Roles
          <ArrowDownIcon />
        </Link>
